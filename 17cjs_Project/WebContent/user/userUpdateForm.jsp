...
<%
	...
	Udao udao = new Udao();
	User u = udao.uSelectForUpdate((String)session.getAttribute("s_id"));
	
%>

						<form action = "<%= request.getContextPath() %>/user/userUpdateAction.jsp" method = "post" id="updateForm">
							
							<h2> 로그인정보  </h2>
								<table>
									<tr>
										<td><p>가입유형</p></td>
										<td><p><input type = "radio" name="user_level" value="<%=u.getUser_level() %>" checked="checked" ><%=u.getUser_level() %></p></td>
									</tr>
									<tr>
										<td><p>아이디</p></td>
										<td><p><input type ="text" name="user_id" value="<%= u.getUser_id() %>" readonly="readonly"><p></td>
									</tr>
									<tr>
										<td><p>비밀번호</p></td>
										<td>
											<p><input type ="password" name="user_pw" id="pw1"><span id="pwHelper"></span></p>
										</td>
									</tr>
									<tr>
										<td><p>비밀번호확인</p></td>
							...
							<h2> 개인정보 </h2>
								<table>
									<tr>
										<td><p>이름</p></td>
										<td><p><input type ="text" name="user_name" value="<%= u.getUser_name() %>" readonly="readonly"></p></td>
									</tr>
									<tr>
										<td><p>성별</p></td>
										<td><p><input type = "radio" name="user_gender" value="<%=u.getUser_gender() %>" checked="checked" ><%=u.getUser_gender() %></p></td>
									</tr>
									<tr>
										<td><p>이메일</p></td>
										<td><p><input type ="text" name="user_email" value="<%=u.getUser_email()%>"></p></td>
									</tr>
									<tr>
										<td><p>주소</p></td>
										<td><p><input type ="text" name="user_home" value="<%=u.getUser_home()%>"></p></td>
									</tr>
									<tr>
										<td><p>휴대폰번호</p></td>
										<td><p><input type ="text" name="user_phone" value="<%=u.getUser_phone()%>"></p></td>
									</tr>
									<tr>
										<td><p>관심지역</p></td>
										<td>
											<p>
												<select name="user_addr">
													<option value="<%=u.getUser_addr() %>" ><%=u.getUser_addr() %></option>
							...
							<p><input type="button" value="수정" id="btn"><p>
